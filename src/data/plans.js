...
export const NBN_PLANS = z.array(nbnPlanSchema).parse([
  ...
  { name: 'NBN 250/100', typical: '250/85 Mbps', price: 110, bundle: 99, featured: true, blurb: 'For VoIP calls, cloud apps & backups', features: ['No lock-in — cancel anytime', 'Unlimited data', 'Free static IP', 'Enhanced service level agreement included', '2 free speed-upgrade days every month'] },
  ...
  { name: 'NBN 750/50', typical: '750/40 Mbps', price: 115, bundle: 103.5, blurb: 'For multi-user offices & cloud usage', features: ['No lock-in — cancel anytime', 'Unlimited data', 'Free static IP', '2 free speed-upgrade days every month'] },
  ...
  { name: 'NBN 500/200', typical: '500/170 Mbps', price: 140, bundle: 126, blurb: 'For upload-heavy work — video, CCTV, sync', features: ['No lock-in — cancel anytime', 'Unlimited data', 'Free static IP', 'Pro service level agreement included'] },
  { name: 'NBN 1000/400', typical: '860/340 Mbps', price: 164, bundle: 147.6, blurb: 'For serious upload & multi-site work', features: ['No lock-in — cancel anytime', 'Unlimited data', 'Free static IP', 'Pro service level agreement included'] },
